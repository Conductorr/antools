...
function ToolCard({ viewBox, path, name }: Props) {
  return (
    <div className={styles.contanier}>
      <div>
        <div className={styles.header}>
          <Icon viewBox={viewBox} path={path} className={styles.header__icon} />
          <div className={styles.header_text}>
            <h1 className={styles.header_text__topic}>{name}</h1>
            <h1 className={styles.header_text__description}>Trial & Paid</h1>
          </div>
        </div>
