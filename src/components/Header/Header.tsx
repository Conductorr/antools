...
import { mainLogo, arrow } from "../../assets/svg";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.navigation}>
        <ul className={styles.navigation_list}>
          <li className={styles.navigation_list__item}>Home</li>
            <div className={styles.navigation_list__item__block}>
          <li className={styles.navigation_list__item}>Categories</li>
          <Icon
            viewBox={arrow.viewBox}
            path={arrow.path}
            className={styles.navigation_list__item_icon}
          />
            </div>
      ...
      <div className={styles.authentication}>
        ...
        <button className={styles.authentication_signUp}>
          <span className={styles.authentication_signUp__text}>Sign Up</span>
        </button>
      </div>
    </div>
  );
